...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'sksdev' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'sksdev' ),
		'repeat-y'  => __( 'Repeat Vertically', 'sksdev' ),
		'repeat'    => __( 'Repeat All', 'sksdev' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'sksdev' ),
		'top center'    => __( 'Top Center', 'sksdev' ),
		'top right'     => __( 'Top Right', 'sksdev' ),
		'center left'   => __( 'Middle Left', 'sksdev' ),
		'center center' => __( 'Middle Center', 'sksdev' ),
		'center right'  => __( 'Middle Right', 'sksdev' ),
		'bottom left'   => __( 'Bottom Left', 'sksdev' ),
		'bottom center' => __( 'Bottom Center', 'sksdev' ),
		'bottom right'  => __( 'Bottom Right', 'sksdev')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'sksdev' ),
		'fixed'  => __( 'Fixed in Place', 'sksdev')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'sksdev' ),
		'italic'      => __( 'Italic', 'sksdev' ),
		'bold'        => __( 'Bold', 'sksdev' ),
		'bold italic' => __( 'Bold Italic', 'sksdev' )
		);
